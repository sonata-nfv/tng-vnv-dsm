  ...
  stage('Promoting release v5.1') {
        ...
        stages {
            stage('Generating release') {
                steps {
                    sh 'docker tag registry.sonata-nfv.eu:5000/tng-vnv-dsm:latest registry.sonata-nfv.eu:5000/tng-vnv-dsm:v5.1'
                    sh 'docker tag registry.sonata-nfv.eu:5000/tng-vnv-dsm:latest sonatanfv/tng-vnv-dsm:v5.1'
                    sh 'docker push registry.sonata-nfv.eu:5000/tng-vnv-dsm:v5.1'
                    sh 'docker push sonatanfv/tng-vnv-dsm:v5.1'
                }
            }
        }
    }
